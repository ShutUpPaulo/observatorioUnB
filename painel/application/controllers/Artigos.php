...
class Artigos extends CI_Controller {
	...
	public function index(){
		...
		$this->grocery_crud->set_relation_n_n('categorias', 'categorias_artigos', 'categorias', 'id_artigo', 'id_categoria', 'categoria');
		$this->grocery_crud->set_relation_n_n('tags', 'artigos_tags', 'tags', 'id_artigo', 'id_tag', 'tag');
		$this->grocery_crud->set_field_upload('capa_artigo','assets/uploads/images');
		$this->grocery_crud->display_as('id_artigo_tag','Tags');
