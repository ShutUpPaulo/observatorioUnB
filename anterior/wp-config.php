...
define('WP_HOME','http://164.41.2.88/observatorio/anterior');
define('WP_SITEURL','http://164.41.2.88/observatorio/anterior');
define('WP_DEFAULT_THEME', 'classic');

// ** Configurações do MySQL - Você pode pegar essas informações com o serviço de hospedagem ** //
/** O nome do banco de dados do WordPress */
define('DB_NAME', 'obs_anterior');

/** Usuário do banco de dados MySQL */
define('DB_USER', 'obs_anterior');

/** Senha do banco de dados MySQL */
define('DB_PASSWORD', 'OBS4nt3r10rOBS');
