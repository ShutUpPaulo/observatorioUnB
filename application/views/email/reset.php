...
<head>
	<meta charset="utf-8" />
	<title>Observatório de Resíduos - Esqueci Senha</title>
...
<body>
	<div>
		...
		<p style="Margin-top: 0;color: #565656;font-size: 16px;line-height: 25px;Margin-bottom: 25px">
			Olá <?php echo $usuario;?>, ficamos sabendo que você esqueceu seu senha.
		</p>
		<p style="Margin-top: 0;color: #565656;font-size: 16px;">
			Não tem problema, <a href="<?php echo $url ?>">clique aqui</a> para trocar sua senha.
		</p>
		<p style="Margin-top: 0;color: #565656;font-size: 16px;line-height: 25px;Margin-bottom: 25px">
